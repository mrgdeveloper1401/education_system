    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_image', models.ImageField(help_text='حجم عکس اپلودی نباید بیش تر از یک مگابایت باشد', null=True, upload_to='best_student_image/%Y/%m/%d', validators=[accounts.validators.validate_upload_image_user])),
                ('is_publish', models.BooleanField(default=True)),
                ('description', models.CharField(max_length=500, null=True)),
                ('attributes', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), null=True, size=None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('mobile_phone', models.CharField(max_length=11, validators=[accounts.validators.MobileRegexValidator()], verbose_name='mobile phone')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='user_image/%Y/%m/%d', validators=[accounts.validators.validate_upload_image_user], verbose_name='عکس')),
                ('second_mobile_phone', models.CharField(blank=True, max_length=11, null=True, validators=[accounts.validators.MobileRegexValidator()], verbose_name='شماره تماس دوم')),
                ('nation_code', models.CharField(max_length=10, null=True, unique=True, validators=[accounts.validators.NationCodeRegexValidator()], verbose_name='کد ملی')),
                ...
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='student_city', to='accounts.city')),
                ('state', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='state', to='accounts.state', verbose_name='استان')),
            ],
            options={
                'verbose_name': 'کاربر',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('char_link', models.CharField(blank=True, help_text='link for redirect', max_length=30, null=True)),
        ...
        migrations.AddField(
            model_name='city',
            name='state',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cites', related_query_name='city', to='accounts.state', verbose_name='استان'),
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_room', models.CharField(help_text='موضوع تیکت', max_length=50, null=True)),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_file', models.FileField(blank=True, null=True, upload_to=api.v1.user.utils.ticket_file_upload_url)),
                ('is_publish', models.BooleanField(default=True)),
                ...
                ('room', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='room', to='accounts.ticketroom')),
            ],
            options={
                'verbose_name': 'تیکت',
