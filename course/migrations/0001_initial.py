    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_publish', models.BooleanField(default=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='category_comments', to='course.category')),
                ('user', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_comment', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'comment',
                'ordering': ('-created_at',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='course_category', to='course.category')),
            ],
            options={
                'db_table': 'course',
                'ordering': ('-created_at',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coach', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='coach_less_course', to='accounts.coach')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='student_call', to='accounts.student')),
                ('lesson_course', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='call', to='course.lessoncourse')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_publish', models.BooleanField(default=True)),
                ('class_room', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='online_link', to='course.lessoncourse')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_publish', models.BooleanField(default=True)),
                ('course', models.ForeignKey(limit_choices_to={'is_publish': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='sections', to='course.course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(editable=False, null=True)),
                ('is_deleted', models.BooleanField(editable=False, null=True)),
                ('image', models.ImageField(null=True, upload_to='certificate/%Y/%m/%d', validators=[course.validators.max_upload_image_validator])),
                ('student', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='student_certificates', to='accounts.student')),
                ('section', models.ForeignKey(limit_choices_to={'is_publish': True}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='section_certificates', to='course.section')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_publish', models.BooleanField(default=True)),
                ('section', models.ForeignKey(limit_choices_to={'is_publish': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='section_files', to='course.section')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_publish', models.BooleanField(default=True)),
                ('section', models.ForeignKey(limit_choices_to={'is_publish': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='section_question', to='course.section')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='student_poll_answer', to='accounts.student')),
                ('section_question', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='section_question', to='course.sectionquestion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_publish', models.BooleanField(default=True)),
                ('section', models.ForeignKey(limit_choices_to={'is_publish': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='section_videos', to='course.section')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='send_section_files', to='accounts.student')),
            ],
            options={
                'db_table': 'send_file',
                'ordering': ('-created_at',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(limit_choices_to={'is_publish': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='student_section', to='course.section')),
                ('student', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='student_access_section', to='accounts.student')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_course', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='lesson_course_enrollment', to='course.lessoncourse')),
                ('student', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='student_enrollment', to='accounts.student')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(limit_choices_to={'is_publish': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='section_score', to='course.section')),
                ('student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='student_section_score', to='accounts.student')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='student_present_absent', to='accounts.student')),
                ('section', models.ForeignKey(limit_choices_to={'is_publish': True}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='section_present_absent', to='course.section')),
            ],
            options={
