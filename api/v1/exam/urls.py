...
exam_router.register(
    "participation", views.ParticipationViewSet, basename="participation"
)
exam_router.register(
    "coach_participation",
    views.ParticipationListRetrieveViewSet,
    basename="coach_participation",
)

participation_router = routers.NestedSimpleRouter(
    exam_router, r"participation", lookup="participation"
)
participation_router.register("answer", views.AnswerViewSet, basename="answer")

question_router = routers.NestedSimpleRouter(
    exam_router, r"questions", lookup="question"
)
...
coach_participation_router.register(
    "coach_user_answer", views.CoachUserAnswerViewSet, basename="coach_user_answer"
)
...
urlpatterns = [
    ...
    path(
        "answers/<int:pk>/score/",
        views.CoachScoreAnswerView.as_view(),
        name="coach-score-answer",
    ),
]
